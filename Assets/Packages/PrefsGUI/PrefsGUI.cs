...
namespace PrefsGUI
{
    ...
    public class Prefs
    {
        //public static void SetFilename (string filename) { PrefsGlobal.SetFilename(filename); }
        public static void Save(string filename) { PrefsGlobal.Save(filename); }
        public static void Load(string filename) { PrefsGlobal.Load(filename); }
