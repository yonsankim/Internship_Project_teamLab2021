...
namespace PrefsWrapper
{
    ...
    {
        //public static void SetFilename (string filename) { PlayerPrefsGlobal.SetFileName(filename); }
        public static void Save(string filename) { PlayerPrefsGlobal.Save(filename); }
        public static void Load(string filename) { PlayerPrefsGlobal.Load(filename); }
